...
data class PixelFitSpacing(
    ...
    val navBar: Dp,
    val navIcon: Dp,
    val navBarLandscape: Dp = (72 * scale).dp,
    val navIconLandscape: Dp = (54 * scale).dp,
    val sideBarWidth: Dp = (72 * scale).dp,
    val sideNavIcon: Dp = (54 * scale).dp,
    val dialogHeight: Dp,
    val cornerXs: Dp,
    val cornerSm: Dp,
    val cornerMd: Dp,
    ...
    companion object {
        fun fromWindow(widthDp: Int, heightDp: Int): PixelFitSpacing {
            ...
            return PixelFitSpacing(
                ...
                navBar = s(80),
                navIcon = s(72),
                navBarLandscape = s(72),
                navIconLandscape = s(48),
                sideBarWidth = s(72),
                sideNavIcon = s(48),
                dialogHeight = s(250),
                cornerXs = s(4),
