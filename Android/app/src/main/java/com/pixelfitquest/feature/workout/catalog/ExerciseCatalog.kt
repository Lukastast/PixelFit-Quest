...
object ExerciseCatalog {
    ...
    val all: List<ExerciseDefinition> = buildList {
        ...
        // Chest — remaining rows are log-only (dumbbells, machines, bodyweight).
        add(e(ExerciseType.INCLINE_BENCH_PRESS, "Incline Bench Press", ExerciseCategory.CHEST, ExerciseEquipment.BARBELL, imu = true))
        add(e(ExerciseType.DECLINE_BENCH_PRESS, "Decline Bench Press", ExerciseCategory.CHEST, ExerciseEquipment.BARBELL, imu = true))
        ...
        add(e(ExerciseType.FLOOR_PRESS, "Floor Press", ExerciseCategory.CHEST, ExerciseEquipment.BARBELL, imu = true))
        ...
        // Back
        add(e(ExerciseType.DEADLIFT, "Deadlift", ExerciseCategory.BACK, ExerciseEquipment.BARBELL, imu = true))
        add(e(ExerciseType.SUMO_DEADLIFT, "Sumo Deadlift", ExerciseCategory.BACK, ExerciseEquipment.BARBELL, imu = true))
        add(e(ExerciseType.ROMANIAN_DEADLIFT, "Romanian Deadlift", ExerciseCategory.BACK, ExerciseEquipment.BARBELL, imu = true))
        ...
        add(e(ExerciseType.GOOD_MORNING, "Good Morning", ExerciseCategory.BACK, ExerciseEquipment.BARBELL, imu = true))
        ...
        // Legs
        add(e(ExerciseType.FRONT_SQUAT, "Front Squat", ExerciseCategory.LEGS, ExerciseEquipment.BARBELL, imu = true))
        ...
        // Shoulders
        add(e(ExerciseType.OVERHEAD_PRESS, "Overhead Press", ExerciseCategory.SHOULDERS, ExerciseEquipment.BARBELL, imu = true))
        ...
        add(e(ExerciseType.REVERSE_CURL, "Reverse Curl", ExerciseCategory.ARMS, ExerciseEquipment.BARBELL, imu = true))
        add(e(ExerciseType.SKULL_CRUSHER, "Skull Crusher", ExerciseCategory.ARMS, ExerciseEquipment.BARBELL, imu = true))
        ...
        add(e(ExerciseType.CLOSE_GRIP_BENCH_PRESS, "Close-Grip Bench Press", ExerciseCategory.ARMS, ExerciseEquipment.BARBELL, imu = true))
